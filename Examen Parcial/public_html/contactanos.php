...
<body class="conta">
        ...
        <div class="inte">
            <p><img src="../public_html/img/Chris.jpg" width="200" height="200" alt="holis"><br>Christopher Martinez Gonzalez <br>Redes sociales <br><a href="https://www.instagram.com/chris_djakfaf/"><i class="fab fa-instagram fa-1x" style="color: #CE95D8;"></i>Instagram</a><br><a href=""><i class="fa-brands fa-twitter fa-1x" style="color: #CE95D8;"></i>Twitter</a></p>
            <p><img src="../public_html/img/vale.jpeg" width="200" height="200" alt="holis 2"><br>Valeria Nuñez de Lira <br>Redes sociales <br><a href="#"><i class="fab fa-instagram fa-1x" style="color: #CE95D8;"></i>Instagram</a><br><a href=""><i class="fa-brands fa-twitter fa-1x" style="color: #CE95D8;"></i>Twitter</a></p>
            <p><img src="" alt="holis 3"><br>Xitlali Sarahi Reyes Reyes <br>Redes sociales <br><a href="#"><i class="fab fa-instagram fa-1x" style="color: #CE95D8;"></i>Instagram</a><br><a href=""><i class="fa-brands fa-twitter fa-1x" style="color: #CE95D8;"></i>Twitter</a></p>
        </div>
        <div class="mapa">
